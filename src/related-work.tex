...
\begin{itemize}
	...
	\item \cite{vodilovksa_hyperparameter_2023} focuses on hyper-parameter optimization for graph neural networks for mRNA degradation prediction. It includes a broader set op hyper-aparameters, but only evaluates the methods on a single dataset.
