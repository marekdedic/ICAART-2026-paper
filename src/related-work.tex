...
\todo[inline]{Expand related work with more references from hyper-parameter optimization literature, convert into text}
...
\begin{itemize}
	...
	\item \cite{yuan_systematic_2021} is the most relevant work\todo{Say why}, but it only evaluates on 3 molecular datasets.
