...
To build the metamodel \( \mathcal{M}_\rho \), we will use an off-the-shelf regression model (in our case, an RF regressor, but other regression models could be used as well) trained on a meta-dataset \( \mathcal{H} \).
