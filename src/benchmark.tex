...
\end{itemize}
The search space included the ReLU and PReLU activation functions, Adam and AdamW optimizers, dropout rates of 0 and 0.5 and mean and max aggregation functions. Other hyperparameter ranges differ across datasets and are listed in Table~\ref{tab:search-space}. The ranges were chosen based on prior art on GNNs \cite{hamilton_inductive_2017, zeng_graphsaint_2019, zhu_beyond_2020, yang_vqgraph_2023, den_boef_graphpope_2021, li_finding_2022}.
