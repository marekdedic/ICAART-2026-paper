...
\begin{itemize}
	\item Pre-training the metamodel on synthetic datasets generated from known graph models (e.g. Erdős–Rényi models, stochastic block models, preferential attachment models) to evaluate whether this can further improve transfer learning performance by providing a richer and more diverse training set for the meta-learner.
